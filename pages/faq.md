...
We understand that generating an assembly meeting the specified quality criteria may not be feasible for all taxa, for reasons such as small organism size or scarcity of sample material due to a threatened species status. If you believe that a genome is of sufficient quality as can be expected for a taxon, even if it does not meet the applicable EBP minimum metrics, you can request that AToL override its typical quality requirements and proceed with brokering the assembly to ENA.
